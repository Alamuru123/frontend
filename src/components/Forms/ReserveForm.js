...
const ReserveForm = () => {
    ...
    const handleFirstSubmit = async (event, data) => {
        ...
        console.log(data); 
        await axios.post('https://res-server-hmno.onrender.com/reservation/availability', data)
        .then(res => {
    ...
    const getUserData = async () => {
        await axios.get(`https://res-server-hmno.onrender.com/user/details/${token}`)
        .then(res => {
          // console.log(res.data);
    ...
    const handleFinalSubmit = async (event, data) => {
        ...
        // console.log(JSON.stringify(data, null, 2));
        // handleNext();
        await axios.post('https://res-server-hmno.onrender.com/reservation/confirm', data)
        .then(res => {
            // console.log(res);
